...
<html>
    ...
    <body>
        <div class="container">
            ...
            <section>
                ...
                <div class="row mt-0 mb-0">
                    <div class="col-5 pl-0">
                        <table class="table table-condensed table-sm mb-0 mt-0">
                            <tbody>
                                <tr>
                                    <td class="font-weight-bold col-5 border">
                                        Fecha Pago Ordinario
                                    </td>
                                    <td class="col border">
                                        {{
                                            $encabezado["fecha_pago_ordinario"]
                                        }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold col-6 border">
                                        Fecha Pago con Recargo
                                    </td>
                                    <td class="border">
                                        {{ $encabezado["fecha_pago_extra"] }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="row">
                    <div class="col pl-0">
                        <p>
                            Si en el momento de realizar el pago se excede la
                            fecha límite indicada deberá reimprimir este
                            documento con los nuevos valores liquidados
                        </p>
                        <p class="text-center mt-0 mb-0 font-weight-bold">
            ...
            <!-- Inicio Documento para Universidad -->
            <section>
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                ...
                <div class="row mb-0 mt-0">
                    <div class="col-5 pl-0 mb-0 mt-0">
                        <table class="table table-condensed table-sm mb-0 mt-0">
                            <tbody>
                                <tr>
                                    <td class="font-weight-bold col-5 border">
                ...
                <div class="row mb-0 mt-0">
                    <div class="col pl-0 mb-0 mt-0">
                        ...
                        <p class="text-center mt-0 mb-0 font-weight-bold">
                            DOCUMENTO PARA INSTITUCION EDUCATIVA
                        </p>
                    </div>
                </div>
            </section>
            <!-- Fin Documento para Universidad -->
            ...
            <section>
                <!-- Inicio documento para el banco -->
